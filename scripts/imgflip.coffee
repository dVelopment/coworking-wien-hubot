...
#   hubot ancient <text> - Ancient Aliens History Channel Guy
#   hubot <text> aliens - Ancient Aliens History Channel Guy - with "Aliens" in the second line
...
#   hubot <text> shut up and take my money - Fry cash in hand
#   hubot drevil <text> - Dr. Evil airquotes
#   hubot ntyson <text> - Neil deGrasse Tyson
#   hubot keep calm and <text> - Keep calm poster background
#   hubot khan <text> - Cpt. Kirk screems "Khaaaan!"
#
# Author:
#   dylanwenzlau
